...
//		JDD.PrintMatrix(trans01, allDDRowVars, allDDColVars, JDD.ZERO_ONE);
	...
	{
		if (!explicit) {
			PrismMTBDD.StochExport(trans, allDDRowVars, allDDColVars, odd, exportType, file.getPath());
		}
		else {
			PrismSparse.StochExport(trans, allDDRowVars, allDDColVars, odd, exportType, file.getPath());
		}
	}
