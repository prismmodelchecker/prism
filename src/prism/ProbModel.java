...
//		JDD.PrintMatrix(trans01, allDDRowVars, allDDColVars, JDD.ZERO_ONE);
	...
	{
		if (!explicit) {
			PrismMTBDD.ProbExport(trans, allDDRowVars, allDDColVars, odd, exportType, file.getPath());
		}
		else {
			PrismSparse.ProbExport(trans, allDDRowVars, allDDColVars, odd, exportType, file.getPath());
		}
	}
