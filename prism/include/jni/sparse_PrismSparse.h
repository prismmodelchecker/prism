 ...
 * Signature: (JJIJIJIZJJJLjava/util/List;[J[D[J[D[D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_sparse_PrismSparse_PS_1NondetMultiObj
  (JNIEnv *, jclass, jlong, jlong, jint, jlong, jint, jlong, jint, jboolean, jlong, jlong, jlong, jobject, jlongArray, jdoubleArray, jlongArray, jdoubleArray, jdoubleArray);
