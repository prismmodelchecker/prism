...
public class PCTLProbNext extends PCTLFormulaUnary
{
	 ...
	 *	Note: Although the simulator supports ProbNext operators, they are 
	...
	{
		throw new SimulatorException("Unexpected Error when loading PCTL Formula into Simulator - Next toSimulator should never be called");
	}
