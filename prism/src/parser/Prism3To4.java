...
// top-level stuff
//-----------------------------------------------------------------------------------
  static final public void ModulesFileOrPropertiesFile() throws ParseException {
...
// modules file
  static final public void ModulesFile() throws ParseException {
    label_1:
    while (true) {
...
// properties file
  static final public void PropertiesFile() throws ParseException {
    label_2:
    while (true) {
...
// a single expression
  static final public void SingleExpression() throws ParseException {
    Expression();
    jj_consume_token(0);
  }
...
// keyword denoting module type (nondeterministic, probabilistic, ...)
  static final public void ModulesFileType() throws ParseException {
