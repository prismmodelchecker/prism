...
public interface FunctionalPrimitiveIterator<E, E_CONS> extends FunctionalIterator<E>, PrimitiveIterator<E, E_CONS>
{
	...
	public interface OfDouble extends FunctionalPrimitiveIterator<Double, DoubleConsumer>, PrimitiveIterator.OfDouble
	{
		...
		{
			if (iterators instanceof PrimitiveIterator.OfDouble[]) {
				return concat((PrimitiveIterator.OfDouble[]) iterators);
			}
		...
		{
			return reduce(this, (FunctionalPrimitiveIterator.OfDouble iter, double e) -> iter);
		}
		...
		default int collectAndCount(double[] array, int offset)
		{
			...
			int index = reduce(offset, (int i, double e) -> {array[i] = e; return i++;});
			return index - offset;
		}
		...
		{
			// avoid auto-boxing
			return reduce(0L, (long c, double d) -> c++);
		}
	...
	public interface OfInt extends FunctionalPrimitiveIterator<Integer, IntConsumer>, PrimitiveIterator.OfInt
	{
		...
		{
			if (iterators instanceof PrimitiveIterator.OfInt[]) {
				return concat((PrimitiveIterator.OfInt[]) iterators);
			}
			return FunctionalPrimitiveIterator.super.concat(iterators);
		}
		...
		{
			return reduce(this, (FunctionalPrimitiveIterator.OfInt iter, int e) -> iter);
		}
		...
		{
			Objects.requireNonNull(array);
			int index = reduce(offset, (int i, int e) -> {array[i] = e; return i++;});
			return index - offset;
		}
		...
		default int collectAndCount(BitSet indices)
		{
			...
			return reduce(0, (int c, int i) -> {indices.set(i); return c++;});
		}
		...
		{
			// avoid auto-boxing
			return reduce(0, (long c, long i) -> c++);
		}
	...
	public interface OfLong extends FunctionalPrimitiveIterator<Long, LongConsumer>, PrimitiveIterator.OfLong
	{
		...
		{
			if (iterators instanceof PrimitiveIterator.OfLong[]) {
				return concat((PrimitiveIterator.OfLong[]) iterators);
			}
			return FunctionalPrimitiveIterator.super.concat(iterators);
		}
		...
		{
			return reduce(this, (FunctionalPrimitiveIterator.OfLong iter, long e) -> iter);
		}
		...
		{
			Objects.requireNonNull(array);
			int index = reduce(offset, (int i, long e) -> {array[i] = e; return i++;});
			return index - offset;
		}
		...
		{
			// avoid auto-boxing
			return reduce(0, (long c, long l) -> c++);
		}
