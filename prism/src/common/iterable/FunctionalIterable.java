 ...
 * </ol>
 * Please note that {@code mapToInt} and {@code filter} only wrap the underlying Iterable.
...
public interface FunctionalIterable<E> extends Iterable<E>
{
	...
	/**
	 * Extend an PrimtiveIterable.OfDouble with the methods provided by FunctionalPrimitiveIterable.
	 * Answer the argument if it already implements {@code FunctionalIterable}.
	 *
	 * @param iterable the {@link PrimitiveIterable.OfDouble} to extend
	 * @return a {@link FunctionalPrimtiveIterable.OfDouble} that is either the argument or an adaptor on the argument
	 */
	public static FunctionalPrimitiveIterable.OfDouble extend(PrimitiveIterable.OfDouble iterable)
	{
	...
	/**
	 * Extend an PrimtiveIterable.OfInt with the methods provided by FunctionalPrimitiveIterable.
	 * Answer the argument if it already implements {@code FunctionalPrimtitiveIterable}.
	 *
	 * @param iterable the {@link PrimtiveIterable.OfInt} to extend
	 * @return a {@link FunctionalPrimtitiveIterable.OfDouble} that is either the argument or an adaptor on the argument
	 */
	public static FunctionalPrimitiveIterable.OfInt extend(PrimitiveIterable.OfInt iterable)
	{
	...
	/**
	 * Extend an PrimtiveIterable.OfLong with the methods provided by FunctionalPrimitiveIterable.
	 * Answer the argument if it already implements {@code FunctionalPrimtitiveIterable}.
	 *
	 * @param iterable the {@link PrimtiveIterable.OfLong} to extend
	 * @return a {@link FunctionalPrimtitiveIterable.OfLong} that is either the argument or an adaptor on the argument
	 */
	public static FunctionalPrimitiveIterable.OfLong extend(PrimitiveIterable.OfLong iterable)
	{
	...
	default FunctionalIterable<E> concat(Iterable<? extends E>... iterables)
	{
		...
		case 0:
			return this;
		case 1:
			return new ChainedIterable.Of<>(new IterableArray.Of<>(this, iterables[0]));
		default:
			Iterable<E> tail = new ChainedIterable.Of<>(new IterableArray.Of<>(iterables));
			return new ChainedIterable.Of<>(new IterableArray.Of<>(this, tail));
		}
	}
	 ...
	 */
	default <T> FunctionalPrimitiveIterable.OfDouble flatMapToDouble(Function<? super E, PrimitiveIterable.OfDouble> function)
	{
	 ...
	 */
	default <T> FunctionalPrimitiveIterable.OfInt flatMapToInt(Function<? super E, PrimitiveIterable.OfInt> function)
	{
	 ...
	 */
	default <T> FunctionalPrimitiveIterable.OfLong flatMapToLong(Function<? super E, PrimitiveIterable.OfLong> function)
	{
	 ...
	 * @throws {@link NullPointerException} if the result of the reduction is {@code null}
