 ...
 * </ol>
 * Please note that {@code mapToInt} and {@code filter} only wrap the underlying Iterator.
...
public interface FunctionalIterator<E> extends Iterator<E>
{
	 ...
	 * Answer the argument's Iterator if it already implements of {@code FunctionalIterator}.
	 *
	 * @param iterable the {@link Iterable} providing the {@link Iterator} to extend
	 * @return a {@link FunctionalIterator} that is either the argument's Iterator or an adaptor on that Iterator
	 */
	...
	/**
	 * Extend the Iterator of a PrimitiveIterable.OfDouble with the methods provided by FunctionalPrimitiveIterator.
	 * Answer the argument's Iterator if it already implements {@code FunctionalPrimitiveIterator.OfDouble}.
	 *
	 * @param iterable the {@link PrimitiveIterable.OfDouble} providing the {@link PrimitiveIterator} to extend
	 * @return a {@link FunctionalPrimitiveIterator.OfDouble} that is either the argument's Iterator or an adaptor on that Iterator
	 */
	public static FunctionalPrimitiveIterator.OfDouble extend(PrimitiveIterable.OfDouble iterable)
	{
		return extend(iterable.iterator());
	}

	/**
	 * Extend the Iterator of a PrimitiveIterable.OfInt with the methods provided by FunctionalPrimitiveIterator.
	 * Answer the argument's Iterator if it already implements {@code FunctionalPrimitiveIterator.OfInt}.
	 *
	 * @param iterable the {@link PrimitiveIterable.OfInt} providing the {@link PrimitiveIterator} to extend
	 * @return a {@link FunctionalPrimitiveIterator.OfInt} that is either the argument's Iterator or an adaptor on that Iterator
	 */
	public static FunctionalPrimitiveIterator.OfInt extend(PrimitiveIterable.OfInt iterable)
	{
		return extend(iterable.iterator());
	}

	/**
	 * Extend the Iterator of a PrimitiveIterable.OfLong with the methods provided by FunctionalPrimitiveIterator.
	 * Answer the argument's Iterator if it already implements {@code FunctionalPrimitiveIterator.OfLong}.
	 *
	 * @param iterable the {@link PrimitiveIterable.OfLong} providing the {@link PrimitiveIterator} to extend
	 * @return a {@link FunctionalPrimitiveIterator.OfLong} that is either the argument's Iterator or an adaptor on that Iterator
	 */
	public static FunctionalPrimitiveIterator.OfLong extend(PrimitiveIterable.OfLong iterable)
	{
		return extend(iterable.iterator());
	}
	...
	default FunctionalIterator<E> concat(Iterator<? extends E>... iterators)
	{
		...
		return new ChainedIterator.Of<>(unwrap(), new ArrayIterator.Of(iterators));
	}
