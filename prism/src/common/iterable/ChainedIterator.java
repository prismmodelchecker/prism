 ...
 * @param <I> common super type of {@link FunctionalIterator#extend} for all Iterators in the chain
 */
public abstract class ChainedIterator<E, I extends FunctionalIterator<E>> implements FunctionalIterator<E>
{
	 ...
	 */
	@SafeVarargs
	public ChainedIterator(Iterator<E> iterator, Iterator<E>... iterators)
	{
	...
	public ChainedIterator(Iterator<E> iterator, Iterator<? extends Iterator<E>> iterators)
	{
		...
		this.current   = (I) FunctionalIterator.extend(iterator);
		this.iterators = (FunctionalIterator<I>) FunctionalIterator.extend(iterators).map(FunctionalIterator::extend);
		hasNext();
	}
