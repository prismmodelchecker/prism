...
public class IteratorTools
{
	...
	{
		return FunctionalIterator.unboxDouble(FunctionalIterator.extend(numbers).nonNull()).max();
	}
	...
	{
		return FunctionalIterator.unboxInt(FunctionalIterator.extend(numbers).nonNull()).max();
	}
	...
	{
		return FunctionalIterator.unboxLong(FunctionalIterator.extend(numbers).nonNull()).max();
	}
	...
	{
		return FunctionalIterator.unboxDouble(FunctionalIterator.extend(numbers).nonNull()).min();
	}
	...
	{
		return FunctionalIterator.unboxInt(FunctionalIterator.extend(numbers).nonNull()).min();
	}
	...
	{
		return FunctionalIterator.unboxLong(FunctionalIterator.extend(numbers).nonNull()).min();
	}
	...
	{
		return FunctionalIterator.unboxDouble(FunctionalIterator.extend(numbers).nonNull()).sum();
	}
	...
	{
		return FunctionalIterator.unboxInt(FunctionalIterator.extend(numbers).nonNull()).sum();
	}
	...
	{
		return FunctionalIterator.unboxLong(FunctionalIterator.extend(numbers).nonNull()).sum();
	}
