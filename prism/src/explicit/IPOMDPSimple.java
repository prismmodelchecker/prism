 ...
 */
public class IPOMDPSimple<Value> extends POMDPSimple<Interval<Value>> implements IPOMDP<Value>
{
	// Constructors
	...
	{
		((IPOMDPSimple<Double>) this).setEvaluator(Evaluator.forDoubleInterval());
	}
}
