...
public class ChoiceProperty extends SingleProperty 
{
    ...
    public String getValue()
    {
        ...
        {
            val = (String)properties.get(currIndex);
            try
            {
                setProperty(val);
            }
    ...
    {
        //System.out.println("calling setproperty on choiceproperty");
        if(properties == null) properties = new ArrayList();
        if(listModel == null) listModel = new DefaultComboBoxModel();
        ...
        {
            //System.out.println("property exception caught, obj.toString() = "+property.toString());
            //System.out.println("property.class = "+property.getClass().toString());
