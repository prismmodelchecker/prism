...
../../bin/prism ../../examples/mdps/wlan/wlan$n\.nm ../../examples/mdps/wlan/cost_max.pctl -s -ii:upper=1e+12 -improvedbk -maxiters 900500 -const COL=5 -const TRANS_TIME_MAX=$ttm > wlan/wlan$n\_$ttm\_cost_max.log
